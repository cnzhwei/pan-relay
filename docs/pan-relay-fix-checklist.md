...
> 建立时间：2026-09-25
> 范围：`v2.1.0`（HEAD `512bd7b63b3d26470cc59c74e096f2a1892ee1eb`）代码与发布元数据
...
- [ ] **P2｜补充发布安装完整性说明**
  ...
  - 当前进展：已修改 CI 生成 `SHA256SUMS.txt`，安装脚本改为无校验文件则拒绝安装；待下一次 GitHub Release 实际发布并回读资产后关闭。
  - 验收：至少生成并发布 SHA-256 校验文件，并在安装脚本中校验。
